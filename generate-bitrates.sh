...
for i in {1..16};do
  ...
  # JPEG2000
  ffmpeg -i images/${i}.png -q:v 100  images/${i}-1.jp2
  ffmpeg -i images/${i}.png -q:v 70   images/${i}-2.jp2
  ffmpeg -i images/${i}.png -q:v 30   images/${i}-3.jp2
  ffmpeg -i images/${i}.png -q:v 1    images/${i}-4.jp2
